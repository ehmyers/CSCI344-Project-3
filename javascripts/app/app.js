    ...
    todos.forEach(function (todo, itemIndex) {
        todo.categories.forEach(function (category) {
            ...
            if (category === category_name) {
                ...
                $("<p data-id='" + todo.id + "'><i class='icon_remove'></i>" + todo.description + "</p>").appendTo("#" + category_name);
            }
...
var refreshMainList = function () {
    ...
    todos.forEach(function (todo) {
        ...
        list_item = "<p id='title_and_category' data-id='" + todo.id + "'><i class='icon_remove'></i>";
